...
It's **overwhelming** work going on in open source world https://github.com/explore, more agency of tools like [search](https://about.sourcegraph.com/) for design patterns will help (but we have a more of problem of bootstrap data).
