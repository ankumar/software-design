...
> It's impressive that Stripe has a Head of Climate (@nanransohoff). It signals both that they know what matters, and that their ambitions are big enough that they need to care about big problems. Eventually every ambitious tech company will have such a person. -- https://twitter.com/paulg/status/1511266839090843651
...
- Open Source
  ...
  - [Backstage](https://github.com/backstage/backstage) / SaaS: https://roadie.io/ [Temporal](https://github.com/temporalio/temporal) [Argo CD](https://github.com/argoproj/argo-cd/)
...
It's **overwhelming** work going on in open source world, more agency tools like [search](https://sourcegraph.com/search?_ga=2.51756911.799392183.1647276458-1410053958.1638741259) including software design will help (right now we have problem of more code and less real world software design).
