First a bit back in time **retrospective** and forward **Amplify** building tools or using best tools, a sustainable model with universal core principle of **Going far, Together** with product, community and engineering. A lot of connecting dots shared from a [following](https://twitter.com/an1kumar/following) on Twitterverse Thank You :pray: ,eternally grateful. 
